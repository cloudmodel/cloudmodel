...
describe CloudModel::Workers::Components::WkhtmltopdfComponentWorker do
  ...
  describe 'build' do
    let(:uri) { double URI, read: '<a href="https://github.com/wkhtmltopdf/packaging/releases/download/0.42.23/wkhtmltox_0.42.23.quick_6502.deb">'}
    ...
    it 'should install wkhtmltopdf' do
      expect(subject).to receive(:chroot!).with("/tmp/build", "wget -q https://github.com/wkhtmltopdf/packaging/releases/download/0.42.23/wkhtmltox_0.42.23.quick_6502.deb && dpkg -i wkhtmltox_0.42.23.quick_6502.deb && apt -f install", "Failed to install packages for wkhtmltopdf")
