  ...
  module Workers
    class SolrImageWorker < BaseWorker
      ...
      def package_build
        ...
        begin
          run_step "Packaging", "tar cpjf #{@solr_image.build_path.shellescape}-building.tar.bz2 --directory #{@solr_image.build_path.shellescape}/#{solr_config} --exclude={'.git','./.gitignore','./.gitmodules','./tmp/**/*','./log/**/*','./spec','./features','.rspec','.gitkeep','./bundle/#{Bundler.ruby_scope}/cache','.bundle/#{Bundler.ruby_scope}/doc'} ."
        rescue CloudModel::ExecutionException => e
          CloudModel.log_exception e
