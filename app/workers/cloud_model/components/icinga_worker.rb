  ...
  module Components
    class IcingaWorker < BaseWorker
      def build build_path
        ...
        #
        # %w(http ssh livestatus webui2 mongodb logstore-sqlite mod-mongodb retention-mongodb graphite2 ui-graphite2 auth-cfg-password named-pipe).each do |service|
